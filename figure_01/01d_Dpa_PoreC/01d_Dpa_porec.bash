...
# Download the pipeline and create a conda environment
...
# Change the /config/references.tsv to point to the appropriate file path to the reference genome, 
# and the /config/basecalls.tsv to point to the appropriate file path to the PoreC reads
#
