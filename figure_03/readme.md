...
The chromosome-to-chromosome alignment was performed using nucmer (from [mummer](https://github.com/mummer4/mummer) suite of programs), and the resulting alignments were plotted using the nucmer output.
