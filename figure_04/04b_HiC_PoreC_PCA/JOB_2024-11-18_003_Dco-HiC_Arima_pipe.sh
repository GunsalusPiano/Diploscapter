#!/bin/bash
#SBATCH --job-name=JOB_2024-11-18_003_Dco-HiC_Arima_pipe
#SBATCH --nodes=1
...
SRA='ERR10228685'
LABEL='Dco_hiC'
BWA='/share/apps/bwa/0.7.17/intel/bin/bwa'
SAMTOOLS='/share/apps/samtools/1.20/intel/bin/samtools'
IN_DIR='./Dco_hiC_reads'
REF='./nxDipCoro1_1.curated_primary.fa'
FAIDX='$REF.fai'
PREFIX='nxDipCoro1_1.curated_primary.fa'
RAW_DIR='./Dco_hiC_analysis/raw_bams'
FILT_DIR='./Dco_hiC_analysis/filtered_bams'
...
TMP_DIR='./Dco_hiC_analysis/temporary_files'
PAIR_DIR='./Dco_hiC_analysis/paired_bams'
REP_DIR='./Dco_hiC_analysis/deduplicated_files'
REP_LABEL=${LABEL}_rep1
MERGE_DIR='./Dco_hiC_analysis/merged_replicates'
MAPQ_FILTER=10
CPU=12
