...
def main():
    # Dcoronatus data files
    subtel_nucmer_files = ["nxDipCoro1_hifi.telomereScore20.Dco1L_subtel.sorted.coords",
                           "nxDipCoro1_hifi.telomereScore20.Dco1R_subtel.sorted.coords",
                           "nxDipCoro1_hifi.telomereScore20.Dco2L_subtel.sorted.coords",
                           "nxDipCoro1_hifi.telomereScore20.Dco2R_subtel.sorted.coords"]
                           
    max_dropoff_files = ["nxDipCoro1_hifi.telomereScore20.Dco1L_subtel.sorted.multiple_hits_eliminated.scanningWindow20.telOccupancyDrop.txt",
                         "nxDipCoro1_hifi.telomereScore20.Dco1R_subtel.sorted.multiple_hits_eliminated.scanningWindow20.telOccupancyDrop.txt",
                         "nxDipCoro1_hifi.telomereScore20.Dco2L_subtel.sorted.multiple_hits_eliminated.scanningWindow20.telOccupancyDrop.txt",
                         "nxDipCoro1_hifi.telomereScore20.Dco2R_subtel.sorted.multiple_hits_eliminated.scanningWindow20.telOccupancyDrop.txt"]
    
    all_subtels = "Dco_subtelomeres.fasta"
    
    sequencing_reads = "nxDipCoro1_hifi.telomereScore20.fasta"
    max_leeway = 50
    
    orig_orientation_gggenomes_genes_file = "Dco.genes.txt"
    orig_orientation_gggenomes_seq_file = "Dco.seq.txt"
    centered_gggenomes_genes_file = "Dco.centered.genes.txt"
    centered_gggenomes_seq_file = "Dco.centered.seq.txt"
    zoomed_in_bases = "Dco.zoomed_in_bases.gapped.txt"
    zoomed_in_bases_no_gaps = "Dco.zoomed_in_bases.no_gaps.txt"
