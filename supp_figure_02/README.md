...
Supplemental Fig. 2 was generated using the text output ```Dco.zoomed_in_bases.gapped.txt``` output. Schematics of these reads (not used in the publication) can be generated using the gggenomes package (https://thackl.github.io/gggenomes/).
