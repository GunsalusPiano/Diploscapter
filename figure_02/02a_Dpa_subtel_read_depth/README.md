...
NB. This analysis was done on an earlier draft of the genome assembly where a duplication in DpaB - an assembly error - meant the coordinates on the right end were 2364 bp off. This has no bearing on the analysis of subtelomeric repeats. 
